        ...
        <main className="relative flex min-h-screen flex-col items-center justify-center px-6 py-24">
            <div className="glass-card w-full max-w-md p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading || (mode === 'register' && countdown > 0)}
                        className="w-full btn-primary py-3 disabled:opacity-50"
                    >
                        {loading
                            ? '处理中...'
                            : mode === 'register'
                                ? (countdown > 0 ? `${countdown} 秒后可重发` : '发送验证邮件')
                                : '登录'}
                    </button>
                </form>
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 transition-colors text-white"
                    >
